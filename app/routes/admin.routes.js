...
module.exports = (app, express, io) => {
   ...
   * else calls it.
   */
  router.get("/dashboard/summary", [authJwt.verifyToken, authJwt.isAdmin], superadminDashboardController.summary);
  router.get("/dashboard/stock",   [authJwt.verifyToken, authJwt.isAdmin], superadminDashboardController.stock);
  router.get("/dashboard/charts",  [authJwt.verifyToken, authJwt.isAdmin], superadminDashboardController.charts);
  ...
  router.post(
    "/distributors/store",
    [authJwt.verifyToken, authJwt.isAdmin, DistributorCreate],
    distributorController.store,
  );
  router.post(
    "/distributors/update/:id",
    [authJwt.verifyToken, authJwt.isAdmin, DistributorUpdate],
  ...
  router.get(
    "/sale-carts",
    [authJwt.verifyToken, authJwt.isAdmin],
    saleCartController.index,
  );
  router.post(
    "/sale-carts/store",
    [authJwt.verifyToken, authJwt.isAdmin],
    saleCartController.store,
  );
  router.delete(
