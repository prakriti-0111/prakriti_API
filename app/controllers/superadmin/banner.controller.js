...
exports.fetch = async (req, res) => {
  ...
  if (!banner) {
    return res
      .status(errorCodes.default)
      .send(formatErrorResponse("Banner not found"));
  }
...
exports.update = async (req, res) => {
  ...
  BannerModel.update(postData, { where: { id: req.params.id } })
    .then((result) => {
...
exports.delete = async (req, res) => {
  ...
  BannerModel.destroy({ where: { id: req.params.id } })
    .then((result) => {
