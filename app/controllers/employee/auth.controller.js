...
const {UserCollection} = require("@resources/employee/UserCollection");
const {RoleCollection} = require("@resources/employee/RoleCollection");
 ...
 * @param res
 */
exports.employeeRoles = async (req, res) => {
  let condition = {[Op.or]: [{is_custom: true}, {is_custom: false, id: {[Op.in]: [getRoleId('manager'), getRoleId('worker')]}}]};
