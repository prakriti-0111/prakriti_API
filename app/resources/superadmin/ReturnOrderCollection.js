...
const {ReturnOrderProductCollection} = require("@resources/superadmin/ReturnOrderProductCollection");

const ReturnOrderCollection = (data) => {
    if(isObject(data)){
...
const getModelObject = (data) => {
    ...
    let products = ReturnOrderProductCollection(data.returnProducts);
    ...
    return {
        ...
        order_date: formatDateTime(order.createdAt, 7),
        return_date: formatDateTime(data.return_date, 7),
